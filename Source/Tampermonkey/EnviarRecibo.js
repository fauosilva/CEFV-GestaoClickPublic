...
(function () {
    ...
    function criarPopUp(){
        let popup = htmlToElement('<div class="bootbox modal fade in" tabindex="-1" role="dialog" aria-hidden="false" id="enviarEmail"> <div class="modal-dialog modal-lg"> <div class="modal-content"> <div class="modal-header"><button type="button" class="bootbox-close-button close" data-dismiss="modal" aria-hidden="true">×</button> <h3 class="modal-title">Enviar Recibo</h3> </div> <div class="modal-body"> <div class="bootbox-body"> <section class="content"> <div class="box"> <div class="row"> <div class="col-sm-12 col-lg-12 col-md-12"> <form action="/recibo/zb3X3e" role="form" target="imprimir-recibo" id="MovimentacoesFinanceiraImprimirReciboForm" method="post" accept-charset="utf-8" _lpchecked="1"> <div style="display:none;" wfd-invisible="true"><input type="hidden" name="_method" value="PUT"></div><input type="hidden" name="imprimir" value="1" autocomplete="off" id="MovimentacoesFinanceiraImprimir" wfd-invisible="true"> <div class="required form-group col-sm-6 col-lg-6 col-md-6"><label for="MovimentacoesFinanceiraNome">Nome do Cliente</label><input name="nome" maxlength="100" value="" required="required" class="required form-control" autocomplete="off" type="text" id="MovimentacoesFinanceiraNome" placeholder="" style="background-image: url(&quot;data:image/png;base64,&quot;); background-repeat: no-repeat; background-attachment: scroll; background-size: 16px 18px; background-position: 98% 50%; cursor: auto;"> </div> <div class="required form-group col-sm-6 col-lg-6 col-md-6"><label for="MovimentacoesFinanceiraNome">Plano de Contas</label><input name="plano" maxlength="30" value="" required="required" class="required form-control" autocomplete="off" type="text" id="MovimentacoesFinanceiraNome" placeholder=""> </div> <div class="required form-group col-sm-6 col-lg-6 col-md-6"><label for="MovimentacoesFinanceiraData">Data do pagamento</label><input name="data" maxlength="10" value="" required="required" class="required datepicker mascara-data form-control" autocomplete="off" type="text" id="MovimentacoesFinanceiraData" placeholder=""></div> <div class="required form-group col-sm-6 col-lg-6 col-md-6"><label for="MovimentacoesFinanceiraValorTotal">Valor</label><input name="valor" required="required" class="mascara-valor required form-control" autocomplete="off" type="text" value="" id="MovimentacoesFinanceiraValorTotal" placeholder=""> </div> <div class="col-sm-12 col-lg-12 col-md-12 required"><label for="MovimentacoesFinanceiraNome">Descrição</label><textarea name="descricao" class="form-control" autocomplete="off" cols="30" rows="6" id="MovimentacoesFinanceiraNome" required="required"></textarea></div> <div class="both col-sm-12 col-lg-12 col-md-12 margin-top-10px"> <button class="btn btn-primary" type="submit"><span class="glyphicon glyphicon-envelope margin-right-10px"></span>Enviar via e-mail</button><a href="javascript:parent.bootbox.hideAll();" class="btn btn-danger"><span class="glyphicon glyphicon-remove margin-right-10px"></span>Cancelar</a> </div> </form> </div> </div> </div> </section> </div> </div> </div> </div> </div>');
        return popup;
    }
